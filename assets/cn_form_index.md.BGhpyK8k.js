import{d as g,s as c,o as d,c as r,I as t,a as i,t as y,F,E as p,x as b,w as h,j as s,at as m}from"./chunks/framework.CaI2wH94.js";const C=g({__name:"index.md.demo.cf712288",setup(o){const l=c({}),e=[{label:"Name",prop:"name",component:"NInput",props:{placeholder:"请输入姓名"}},{label:"Address",prop:"address",component:"NInput"}];return(a,k)=>{const n=p("ProForm");return d(),r(F,null,[t(n,{modelValue:l.value,"onUpdate:modelValue":k[0]||(k[0]=E=>l.value=E),columns:e},null,8,["modelValue"]),i(" "+y(JSON.stringify(l.value)),1)],64)}}}),B=g({__name:"index.md.demo.cf712286",setup(o){const l=c({}),e=[{label:"Name",prop:"name",component:"NInput"},{label:"Address",prop:"address",component:"NInput"}],a={name:{required:!0,message:"请输入姓名",trigger:"blur"},address:{required:!0,message:"请输入地址",trigger:"blur"}};return(k,n)=>{const E=p("ProForm");return d(),r(F,null,[t(E,{modelValue:l.value,"onUpdate:modelValue":n[0]||(n[0]=u=>l.value=u),columns:e,rules:a},null,8,["modelValue"]),i(" "+y(JSON.stringify(l.value)),1)],64)}}}),f=g({__name:"index.md.demo.cf712284",setup(o){const l=c({}),a=[{label:"姓名",prop:"name",component:"NInput",span:12},{label:"地址",prop:"address",component:"NInput",span:12},{label:"选择",prop:"select",component:"n-select",props:{options:[{label:"Everybody's Got Something to Hide Except Me and My Monkey",value:"song0",disabled:!0},{label:"Drive My Car",value:"song1"},{label:"Norwegian Wood",value:"song2"},{label:"You Won't See",value:"song3",disabled:!0},{label:"Nowhere Man",value:"song4"},{label:"Think For Yourself",value:"song5"},{label:"The Word",value:"song6"},{label:"Michelle",value:"song7",disabled:!0},{label:"What goes on",value:"song8"},{label:"Girl",value:"song9"},{label:"I'm looking through you",value:"song10"},{label:"In My Life",value:"song11"},{label:"Wait",value:"song12"}]}}];return(k,n)=>{const E=p("ProForm");return d(),r(F,null,[t(E,{modelValue:l.value,"onUpdate:modelValue":n[0]||(n[0]=u=>l.value=u),columns:a},null,8,["modelValue"]),i(" "+y(JSON.stringify(l.value)),1)],64)}}}),v=g({__name:"index.md.demo.cf712282",setup(o){const l=c({}),e=[{label:"Name",description:"这是第一个步骤",children:[{label:"Name",prop:"name",component:"NInput",props:{placeholder:"请输入姓名"}},{label:"Address",prop:"address",component:"NInput"}]},{label:"Name2",description:"这是第二个步骤",children:[{label:"Name2",prop:"name2",component:"NInput",props:{placeholder:"请输入姓名"}},{label:"Address2",prop:"address2",component:"NInput"}]}];return b(()=>{console.log(l.value)}),(a,k)=>{const n=p("ProForm");return d(),r(F,null,[t(n,{modelValue:l.value,"onUpdate:modelValue":k[0]||(k[0]=E=>l.value=E),columns:e,type:"steps"},null,8,["modelValue"]),i(" "+y(JSON.stringify(l.value)),1)],64)}}}),_=s("h1",{id:"proform",tabindex:"-1"},[i("ProForm "),s("a",{class:"header-anchor",href:"#proform","aria-label":'Permalink to "ProForm"'},"​")],-1),D=s("blockquote",null,[s("p",null,"高级表单用于快速构建表单视图")],-1),N=s("h2",{id:"基础用法",tabindex:"-1"},[i("基础用法 "),s("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1),A=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," setup"),s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," lang"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"="),s("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},'"ts"'),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),i(`
...
`,options:"{}"},{highlight:h(()=>[A]),default:h(()=>[t(C)]),_:1}),P,t(a,{customClass:"",sourceCode:`<script setup lang="ts">
import { ref } from 'vue'
...
`,options:"{}"},{highlight:h(()=>[x]),default:h(()=>[t(B)]),_:1}),I,t(a,{customClass:"",sourceCode:`<script setup lang="ts">
import { ref} from 'vue'
...
`,options:"{}"},{highlight:h(()=>[T]),default:h(()=>[t(f)]),_:1}),S,t(a,{customClass:"",sourceCode:`<script setup lang="ts">
...
`,options:"{}"},{highlight:h(()=>[q]),default:h(()=>[t(v)]),_:1}),V,w,M])}}});export{J as __pageData,G as default};
