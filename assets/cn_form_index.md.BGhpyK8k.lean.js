...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  {{ "),s("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"JSON"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"."),s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"stringify"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"(formData) }}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),V=m("",14),w=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"参数"),s("th",null,"类型"),s("th",null,"可选值"),s("th",null,"默认值"),s("th",null,"说明")])]),s("tbody",null,[s("tr",null,[s("td",null,"justify"),s("td",null,[s("code",null,"string")]),s("td",null,[s("code",null,"'start' | 'end' | 'center' | 'space-around' | 'space-between' | 'space-evenly'")]),s("td",null,"start"),s("td",null,"布局对齐方式")]),s("tr",null,[s("td",null,"submit"),s("td",null,[s("code",null,"boolean")]),s("td",null,"-"),s("td",null,"true"),s("td",null,"提交按钮")]),s("tr",null,[s("td",null,"submitText"),s("td",null,[s("code",null,"string")]),s("td",null,"-"),s("td",null,"-"),s("td",null,"默认 i18n 文本")]),s("tr",null,[s("td",null,"submitProps"),s("td",null,[s("code",null,"ButtonProps")]),s("td",null,"-"),s("td",{"type:":"",primary:""}),s("td",null,[i("提交按钮 传入的"),s("strong",null,"props")])]),s("tr",null,[s("td",null,"reset"),s("td",null,[s("code",null,"boolean")]),s("td",null,"-"),s("td",null,"true"),s("td",null,"重设按钮")]),s("tr",null,[s("td",null,"resetText"),s("td",null,[s("code",null,"string")]),s("td",null,"-"),s("td",null,"-"),s("td",null,"默认 i18n 文本")]),s("tr",null,[s("td",null,"resetProps"),s("td",null,[s("code",null,"ButtonProps")]),s("td",null,"-"),s("td",null,"-"),s("td",null,[i("重设按钮 传入的"),s("strong",null,"props")])])])],-1),M=m("",4),J=JSON.parse('{"title":"ProForm","description":"","frontmatter":{},"headers":[],"relativePath":"cn/form/index.md","filePath":"cn/form/index.md"}'),W={name:"cn/form/index.md"},G=Object.assign(W,{setup(o){return(l,e)=>{const a=p("demo");return d(),r("div",null,[_,D,N,t(a,{customClass:"",sourceCode:`<script setup lang="ts">
  import { ref } from 'vue'
  const formData = ref({});
  const columns = [
    {
