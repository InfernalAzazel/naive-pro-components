import{d as o,v as y,o as E,b as c,w as h,J as k,a as i,t as F,G as e,c as u,k as s}from"./chunks/framework.Gemibffn.js";const C=o({__name:"query.md.demo.7ba06332",setup(t){const a=y({}),n=[{label:"姓名",prop:"name",component:"NInput",props:{placeholder:"请输入姓名"}},{label:"地址",prop:"address",component:"NInput"},{label:"选择",prop:"select",component:"n-select",props:{options:[{label:"Everybody's Got Something to Hide Except Me and My Monkey",value:"song0",disabled:!0},{label:"Drive My Car",value:"song1"},{label:"Norwegian Wood",value:"song2"},{label:"You Won't See",value:"song3",disabled:!0},{label:"Nowhere Man",value:"song4"},{label:"Think For Yourself",value:"song5"},{label:"The Word",value:"song6"},{label:"Michelle",value:"song7",disabled:!0},{label:"What goes on",value:"song8"},{label:"Girl",value:"song9"},{label:"I'm looking through you",value:"song10"},{label:"In My Life",value:"song11"},{label:"Wait",value:"song12"}],placeholder:"请选择地址"}}];return(D,l)=>{const r=e("ProQueryForm"),d=e("n-space");return E(),c(d,{vertical:""},{default:h(()=>[k(r,{modelValue:a.value,"onUpdate:modelValue":l[0]||(l[0]=g=>a.value=g),columns:n,onSearch:l[1]||(l[1]=()=>console.log("搜索结果")),onReset:l[2]||(l[2]=()=>console.log("重置"))},null,8,["modelValue"]),i(" "+F(JSON.stringify(a.value)),1)]),_:1})}}}),m=s("h1",{id:"proqueryform",tabindex:"-1"},[i("ProQueryForm "),s("a",{class:"header-anchor",href:"#proqueryform","aria-label":'Permalink to "ProQueryForm"'},"​")],-1),B=s("blockquote",null,[s("p",null,"高级表单用于快速构建表单视图")],-1),b=s("h2",{id:"基础用法",tabindex:"-1"},[i("基础用法 "),s("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1),v=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," setup"),s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," lang"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"="),s("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},'"ts"'),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),A=JSON.parse('{"title":"ProQueryForm","description":"","frontmatter":{},"headers":[],"relativePath":"cn/form/query.md","filePath":"cn/form/query.md"}'),f={name:"cn/form/query.md"},M=Object.assign(f,{setup(t){return(a,p)=>{const n=e("demo");return E(),u("div",null,[m,B,b,k(n,{customClass:"",sourceCode:`<script setup lang="ts">
import { ref } from 'vue'
...
`,options:"{}"},{highlight:h(()=>[v]),default:h(()=>[k(C)]),_:1})])}}});export{A as __pageData,M as default};
